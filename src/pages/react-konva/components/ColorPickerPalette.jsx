	...
	render() {
		...
		return (
			<div ref="colorPicker" id={colorPickerId} className="colorPickerPalette">
				<div ref="previewColorMarker" id={previewColorMarkerId} className="colorPickerPalette--previewColorMarker"></div>
				<canvas
