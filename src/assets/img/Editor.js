...
//       (stageBox.left + absPos.x + this.containerCanvas.current.scrollLeft) /
//       this.state.zoom;
...
//   addNewCircle = () => {
//     let { arrayObjectsLayer } = this.state;
//     let newCircleObj = Object.assign(
//       {},
//       {
//         ...this.state.newCircleObj,
//         x: horizontalCenter + arrayObjectsLayer.length * 50,
//         y: verticalCenter + arrayObjectsLayer.length * 50,
//       }
//     );
...
//             <div className="containerIconeToolbar" onClick={this.imageToBlob}>
//               <img className="img" src={Save} title="Save as png"></img>
//             </div>
//             <div className="containerIconeToolbar" onClick={this.desfazer}>
//               <img className="img" src={Desfazer} title="Desfazer"></img>
//             </div>
//             <div className="containerIconeToolbar" onClick={this.refazer}>
...
//                 className="img"
//                 src={Front}
//                 title="Trazer elemento para frente"
//               ></img>
//             </div>
//             <div
//               className="containerIconeToolbar"
...
//                 className="img"
//                 src={Back}
//                 title="Levar elemento para trás"
//               ></img>
//             </div>
//             <div
//               className="containerIconeToolbar"
...
//               </Stage>
//             </div>
//             <div className="containerBtnExportar"></div>
//             {arrayObjectsLayer &&
//               arrayObjectsLayer.map((item, index) => {
//                 return item ? (
//                   <textarea
